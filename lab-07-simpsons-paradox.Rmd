...
1.  What type of study do you think these data come from: observational or experiment?
    ...
    ***This data was from an obvervational study, there was no assigned treatment groups for people***
    
2.  How many observations are in this dataset?
    What does each observation represent?
    
    ***There are `r nrow(Whickham)` obserevations in this dataset. Each observation represent one particular wome in the study.***
...
3.  How many variables are in this dataset?
    ...
    ***There are `r ncol(Whickham)` Varieblein the dataset. Both `outcome` and `smoker` are character data that are 2 level facters and `age` is a numerical data***
...
***This does not meet what I thought would happen. I t appears that those who smoked have higher probability of being alive 20 years later***
...
***In the plot it appears that smokers have a higher probability of being dead in age category***
